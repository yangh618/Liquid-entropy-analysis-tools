...
#+title: Liquid-entropy-analysis-tools (LEAT)
#+date: <2025-09-08 Mon>
#+author: Huang Yang
#+email: huangyang@fedora
#+language: en
#+select_tags: export
...
It requires GNU Scientific Library (GSL), which, in general, is installed by default in Linux operating systems. Or you can refer to [[https://www.gnu.org/software/gsl/][GSL website]].
